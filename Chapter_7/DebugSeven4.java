...
for(int i = 0; i < stringLength; i++)// removed = from <=
{
char ch = Character.toLowerCase(aString.charAt(i)); //changed from aStringcharAt(i)); to aStringcharAt(i));
System.out.print(ch);
...
System.out.println("The number of LETTERS is + numLetters");//unclosed string literal, added " after the numLetters
}
}
