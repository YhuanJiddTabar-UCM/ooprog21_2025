...
public static void compareNames(String n1, String n2) //wrong spelling.  from comparNames changed to compareNames.
                                                      //  added a String data type to the n2 variable
{
